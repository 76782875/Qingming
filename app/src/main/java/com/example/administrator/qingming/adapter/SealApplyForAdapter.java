...
public class SealApplyForAdapter extends RecyclerView.Adapter<SealApplyForAdapter.ViewHolder> {
    List<ModelSealApplyFor.ResultBean> list;
    Context context;
    private OnItemClickListener mOnItemClickListener = null;

    public SealApplyForAdapter(List<ModelSealApplyFor.ResultBean> list,Context context){
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_seal_apply_for,null);
